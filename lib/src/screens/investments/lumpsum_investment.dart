...
class LumpsumInvestment extends StatefulWidget {
  const LumpsumInvestment({super.key});

  @override
  State<LumpsumInvestment> createState() => _LumpsumInvestmentState();
}

class _LumpsumInvestmentState extends State<LumpsumInvestment> {
  ...
  calculate() {
    ...
    maturityAmount = amount * ((math.pow(1 + r, duration)));
    setState(() {
